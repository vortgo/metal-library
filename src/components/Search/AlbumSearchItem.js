...
class AlbumSearchItem extends React.Component {
    render() {
        return (
                        ...
                        <Row>
                            <Col size={10}>
                                <Text numberOfLines={1} style={styles.text}>
                                    {this.props.item.name} <Text numberOfLines={1} style={styles.bandNameText}>
                                    - {this.props.item.band_name}
                                </Text>
                                </Text>
...
export default withNavigation(AlbumSearchItem)
